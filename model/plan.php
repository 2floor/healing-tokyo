						...
						<div class="planDetailBox">
							...
							<div class="planDetailBoxRight">
								...
								<div class="planPriceBox2">
									...
									<div class="planPrice1">￥<?php print number_format($tour['tour_base']['adult_fee']) ;?> per person<span class="planPrice2">(IN TAX)</span><?php print  $tour['tour_base']['discount_rate_setting']?>% OFF
									</div>
								</div>
