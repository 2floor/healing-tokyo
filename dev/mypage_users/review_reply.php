...
<script type="text/javascript">
 ...
 $(el).addClass("sp-selectable").css("cursor", "pointer");
	...
	$('#conf_submit').click(function(){
		...
		if ($('[name=return_msg]').val() == '' || $('[name=tantou]').val() == '') {
			alert('返信内容と担当は必須です。');
			return false;
		} else {
			$('#frm').submit();
...
<!-- 			</div> -->
			<div class="container1080 cf">
				<div class="container760">
					...
					<form action="review_conf.php?id=<?php print $_GET['id']?>" method="post" name="frm" id="frm">
							...
							<div class="storeEditIn">
								...
								<div class="storeEditItem">
									<div class="storeEditRow">
										...
										<div class="storeEditForm">
											<div class="reservPlanName">
												<?php print $review_row['plan_name']?>
											</div>
										</div>
									</div>
									<div class="storeEditRow">
										...
										<div class="storeEditForm">
												<?php print $review_member_row['name']?>
										</div>
									</div>
									<div class="storeEditRow">
										<div class="storeEditCate">ニックネーム</div>
										<div class="storeEditForm">
												<?php print $review_row['name']?>
										</div>
									</div>
									<div class="storeEditRow">
									...
									<div class="storeEditRow">
										...
										<div class="storeEditForm">
											<?php print nl2br($review_row['rev_text1'])?>
										</div>
									</div>
									<div class="storeEditRow">
										<div class="storeEditCate">店の雰囲気やサービスについて</div>
										<div class="storeEditForm">
											<?php print nl2br($review_row['rev_text2'])?>
										</div>
									</div>
									<div class="storeEditRow">
										<div class="storeEditCate">一緒に行った相手の反応について</div>
										<div class="storeEditForm">
											<?php print nl2br($review_row['rev_text3'])?>
										</div>
									</div>
									...
									<div class="storeEditRow">
										...
										<div class="storeEditForm">
											<textarea name="return_msg" id="" rows="5" cols="" class="formTxt1"></textarea>
											<input type="hidden" name="hid_id" value="<?php print $_GET['id']?>">
										</div>
									</div>
									<div class="storeEditRow">
										<div class="storeEditCate">担当者氏名</div>
										<div class="storeEditForm">
											<input type="text" name="tantou" id="" class="formTxt1">
										</div>
									</div>
								</div>
							</div>
