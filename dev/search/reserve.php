...
if(strpos($tour['tour']['payment_way'], "0") !== false ){
	$payment_way .= '<label class="formRBox radioStyle"><input type="radio" name="payment_way" value="1" class="validate" style="width: 15px; height: auto;" checked="checked"><span>Cash on site</span></label>';
}
if(strpos($tour['tour']['payment_way'], "2") !== false ){
	$payment_way .= '<label class="formRBox radioStyle"><input type="radio" name="payment_way" value="3" class="validate" style="width: 15px; height: auto;"><span>Credit card on site（'.$tour['tour']['card_choice'].'）</span></span></label>';
}

if(strpos($tour['tour']['payment_way'], "1") !== false ){
	$payment_way .= '<label class="formRBox radioStyle"><input type="radio" name="payment_way" value="2" class="validate" style="width: 15px; height: auto;"><span> Immediate payment by credit card（VISA / Master）</span></span></label>';
}
