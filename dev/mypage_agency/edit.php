    ...
    return markerCenter;
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										...
										<label><span class="formRBox"><input type="checkbox" name="payment_way" value="1" class="validate" style="width: 15px; height: auto; display: inline;">クレジットカード決済　Advance collection by JIS</span></label>
										<p class="formBoxSmall">JISにてカード決済 (サービス完了後、月末締めにてJISよりコミッション分を、ご請求致します。
										JISにてクレジットカード代行決済 (カード決済手数料3%を頂きます。サービス完了後、月末締めにて、JISより 事業者様へ コミッションを引いて、お支払い致します。）</p>
									</div>
								</div>
