...
ログインページ https://jis-j.com/login.php
アクティビティ登録について
アクティビティ登録基本編 https://jis-j.com/manual/Activity_registration_manual_basics.pdf
1日に2回以上催行の場合等、登録応用編 https://jis-j.com/manual/Activity_registration_manual_application.pdf
...
空き人数管理（ブロック数管理）に関して https://jis-j.com/manual/Block_management_manual.pdf

会員情報編集は https://jis-j.com/manual/Company_Information_Management_Registration_Manual.pdf をご参考に入力をお願い致します。

尚、これら上記のリンク先につきましては今後もアクセスする機会があると思われますので、ブックマークをして頂くか、
このメールを保存して頂きますようお願い致します。

ご不明な点やご質問などございましたら、enquiry@jis-j.com まで
お気軽にお問い合せください。
