...
";
		...
		$subject = "【Japan International Services】Payment completed.";
		$subject_adminer = "【Japan International Services】Reservation entered.";
		$body = "
/***********************************************************/
...
";
		...
		mb_send_mail("kawahata@2floor.jp", $subject_adminer, base64_encode($body_adminer), $header);
		mb_send_mail("kawahata@2floor.jp", $subject, base64_encode($body), $header);
