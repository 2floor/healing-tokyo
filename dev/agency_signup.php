							...
							<div class="storeEditRow">
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<input type="text" name="company_name_eng" id="company_name_eng" class="formTxt1 validate " value="" placeholder="Japan International Service Co.,Ltd.">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">メールアドレス<br>Mail address</div>
									<div class="storeEditForm required_form">
										<input type="text" name="mail" id="mail" class="formTxt1 validate required mail depricate_check" value="" own="<?php print $_SESSION['jis']['login_member']['store_basic_id']?>" placeholder="info@jis-j.com">
									</div>
								</div>
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<input type="text" name="contact_name_eng" id="contact_name_eng" class="formTxt1 validate " value=""placeholder="Takahashi">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">電話番号<br>Phone no.</div>
									<div class="storeEditForm required_form">
										<input type="tel" name="tel" id="tel" class="formTxt1 validate required tel" value="" placeholder="0345881055">
										<p>ハイフンは入れないでください</p>
									</div>
								</div>
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<input type="tel" name="fax" id="fax" class="formTxt1 validate tel " value="" placeholder="0363000887">
										<p>ハイフンは入れないでください</p>
									</div>
								</div>
								<div class="storeEditRow">
									...
									<div class="storeEditForm required_form">
										<input type="tel" name="emergency_tel" id="emergency_tel" class="formTxt1 validate required tel" value="" placeholder="08055360555">
										<p>ハイフンは入れないでください</p>
									</div>
								</div>
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<input type="text" name="emergency_contact_name" id="emergency_contact_name" class="formTxt1 validate " value="" placeholder="Takahashi">
									</div>
								</div>
