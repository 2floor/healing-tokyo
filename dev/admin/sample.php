...
<script src="../assets/admin/js/sample.js"></script>
...
<input type="hidden" id="ct_url" value="../controller/admin/sample_ct.php">
...
<!--  //ファイル即時アップロード用CT -->
<input type="hidden" id="img_path1" value="sample/">
