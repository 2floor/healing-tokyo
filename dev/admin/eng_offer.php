...
<script src="../assets/admin/js/eng_offer.js"></script>
...
<input type="hidden" id="ct_url" value="../controller/admin/eng_offer_ct.php">
...
<!--  //ファイル即時アップロード用CT -->
<input type="hidden" id="img_path1" value="eng_offer/">
