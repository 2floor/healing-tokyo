							...
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50" >
												<input type="text" class="form-control validate required" name="code">
											</div>
										</div>
									</div>
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate required" name="description1" id="description1" value="">
											</div>
										</div>
									</div>
...
<script src="../assets/admin/js/code.js"></script>
...
<input type="hidden" id="ct_url" value="../controller/admin/code_ct.php">
...
<!--  //ファイル即時アップロード用CT -->
<input type="hidden" id="img_path1" value="code/">
