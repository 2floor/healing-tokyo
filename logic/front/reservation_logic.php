...
";
		...
		$subject = "【healing-tokyo】Your booking has been completed.";
		$subject_adminer = "【healing-tokyo】アクティビティの予約が入りました";
		$body = "
...
";
		...
		mb_send_mail("tech@2floor.jp", "".$subject_adminer, base64_encode($body_adminer_jis), $header);
