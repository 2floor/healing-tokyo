...
class veritrans{
	...
	const DUMMY_PAYMENT_FLAG = "0";//ダミー決済フラグ(本番時0を設定)
	...
	const CARD_CAPTURE_FLAG = '1'; //与信・売上同時決済処理用フラグ
	const LANG = 'en';

	const FINISH_PAYMENT_ACCESS_URL = 'https://credit.jis-j.com/logic/common/veritrans_result.php';//決済結果通知URL
	const FINISH_PAYMENT_RETURN_URL = 'https://jis-j.com/search/reserve_comp.php';//決済後URL
	...
	public function create_key($check_flg = false) {
		$params = array(
				...
				"CARD_CAPTURE_FLAG" => self::CARD_CAPTURE_FLAG,
				"LANG" => self::LANG,
		);
