...
if($_GET['tid'] != null && $_GET['tid'] != ''){
	...
	if($tour['tour_base']['discount_rate_setting'] > 0){
		...
		$dep_html  = '<div class="planPrice1 Before" style="text-decoration: line-through; text-align: left;margin-bottom: 10px;">
							￥'.number_format($tour['tour_base']['adult_fee']) .' per person
							<span class="planPrice2">(IN TAX)</span>→
						</div>';
	}else{
						...
						<div class="planDetailBox">
							...
							<div class="planDetailBoxRight">
								...
								<div class="planPriceBox2">
									<?php print $dep_html;?>
									<div class="planPrice1">￥<?php print number_format($descPrioce) ;?> per person<span class="planPrice2">(IN TAX)</span><?php print $descper?>
									</div>
								</div>
