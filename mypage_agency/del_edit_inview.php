...
<script type="text/javascript" src="../assets/front/js/edit_inview.js"></script>
				...
				<div class="container760">
					...
					<section>
						...
						<div class="storeEditBtnBox">
							...
							<span class="storeEditImgList"><a href="javascript:void(0)" class="active">店内写真</a></span>
...
<!-- 								</div> -->
							...
							<div class="storeEditItem">
<!-- 								<div class="storeEditRow"> -->
<!-- 									<div class="storeEditCate">店内2名称</div> -->
<!-- 									<div class="storeEditForm"> -->
<!-- 										<input type="text" name="" class="formTxt1"> -->
<!-- 									</div> -->
<!-- 								</div> -->
								<div class="storeEditRow">
									<div class="storeEditCate">店内2説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_2"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">店内2画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
<!-- 								<div class="storeEditRow"> -->
<!-- 									<div class="storeEditCate">店内3名称</div> -->
<!-- 									<div class="storeEditForm"> -->
<!-- 										<input type="text" name="" class="formTxt1"> -->
<!-- 									</div> -->
<!-- 								</div> -->
								<div class="storeEditRow">
									<div class="storeEditCate">店内3説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_3"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">店内3画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
<!-- 								<div class="storeEditRow"> -->
<!-- 									<div class="storeEditCate">店内4名称</div> -->
<!-- 									<div class="storeEditForm"> -->
<!-- 										<input type="text" name="" class="formTxt1"> -->
<!-- 									</div> -->
<!-- 								</div> -->
								<div class="storeEditRow">
									<div class="storeEditCate">店内4説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_4"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">店内4画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
<!-- 								<div class="storeEditRow"> -->
<!-- 									<div class="storeEditCate">店内5名称</div> -->
<!-- 									<div class="storeEditForm"> -->
<!-- 										<input type="text" name="" class="formTxt1"> -->
<!-- 									</div> -->
<!-- 								</div> -->
								<div class="storeEditRow">
									<div class="storeEditCate">店内5説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_5"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">店内5画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
<!-- 								<div class="storeEditRow"> -->
<!-- 									<div class="storeEditCate">店内6名称</div> -->
<!-- 									<div class="storeEditForm"> -->
<!-- 										<input type="text" name="" class="formTxt1"> -->
<!-- 									</div> -->
<!-- 								</div> -->
								<div class="storeEditRow">
									<div class="storeEditCate">店内6説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_6"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">店内6画像</div>
									<div class="storeEditForm">
...
<input type="hidden" id="img_path1" value="store_detail_img/interior/">
<input type="hidden" id="img_path2" value="store_detail_img/interior/">
<input type="hidden" id="img_path3" value="store_detail_img/interior/">
<input type="hidden" id="img_path4" value="store_detail_img/interior/">
<input type="hidden" id="img_path5" value="store_detail_img/interior/">
<input type="hidden" id="img_path6" value="store_detail_img/interior/">
