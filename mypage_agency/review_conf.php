...
$rev = $common_logic->select_logic("select * from t_review where review_id = ? and del_flg = 0  and public_flg = 0 ", array($_POST['review_id']));
$row = $rev[0];
		...
		<div id="wrap1080">
			<div class="container1080 cf">
				<div class="container760">
					...
					<form action="review_regist.php" method="post" name="frm" id="frm">
								...
								<div class="storeEditItem">
									...
									<div class="storeEditRow">
										...
										<div class="storeEditForm">
											...
											<?php print nl2br($_POST['reply'])?>
											<input type="hidden" name="review_id" value="<?php print $row['review_id']?>">
											<input type="hidden" name="reply" value="<?php print $_POST['reply']?>">
										</div>
									</div>
								</div>
							</div>
