						...
						<div class="storeEditIn">
							...
							<div class="storeEditRow">
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm required_form">
										<input type="text" name="mail" id="mail" class="formTxt1 validate required " value="" placeholder="info@healing-tokyo.com" own="<?php print $_SESSION['jis']['login_member']['store_basic_id']?>">
									</div>
								</div>
								<div class="storeEditRow">
								...
								<div class="storeEditRow password_change_form">
									...
									<div class="storeEditForm">
										<input type="text" name="password" id="password" class="formTxt1 validate required password half_width" value="">
									</div>
								</div>
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<input type="text" name="url" id="url" class="formTxt1 validate " value="" placeholder="https://healing-tokyo.com">
									</div>
								</div>
								<div class="storeEditRow">
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm ">
										<p>Healing Tokyoが領収したアクティビティ費用等のお支払先</p>
