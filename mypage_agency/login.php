				...
				<div class="container760">
						...
						<div class="prts__contents_19">
							...
							<div class="mypageTopNameBox">
								<div class="registTopTxt">
									Login is required to use this service. If you are not yet a member, please <a href="mypage_users/new_member.php">click here<i class="fas fa-external-link-alt"></i></a> for membership registration procedures.<br>
									(初めての企業様は<a href="agency_signup.php">こちら</a>からお手続きをお願い致します)
								</div>
							</div>
						</div>
					</section>
					<section class="borderBox">
						<form action="./logic/front/login_logic.php?er=<?php print $_GET["er"]?>" name="login_form" method="post">
							...
							<div class="storeEditBtnBox authLoginImgBox mT20 sns_b">
								<a class="authLoginImg" href="<?php print $loginUrl?>">
									<img alt="" src="./img/17639236_1785253958471956_282550797298827264_n.png">
								</a>
								<a class="authLoginImg" href="oauth_google.php">
						...
						<h4 class="loginReissue">
							<a href="reminder.php"><strong>Click here for password reissue</strong></a>
						</h4>
