...
<script type="text/javascript" src="../assets/front/js/edit_staff.js"></script>
			...
			<div class="container1080 cf">
				<div class="container760">
					...
					<section>
						...
						<div class="storeEditBtnBox">
							<span class="storeEditImgList"><a href="edit_appearance.php">店外写真</a></span>
							<span class="storeEditImgList"><a href="edit_inview.php">店内写真</a></span>
							<span class="storeEditImgList"><a href="edit_staff.php" class="active">スタッフ写真</a></span>
							<span class="storeEditImgList"><a href="edit_cuisine.php">料理写真</a></span>
						</div>
					</section>

					<section class="borderBox">
						<div class="storeEditIn">
							<h4 class="titleBN">スタッフ写真登録・編集</h4>
							<div class="storeEditItem">
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ1名称</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 title_area store_detail_title_1">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ1役職</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 job_area store_job_title_1">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ1説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_1"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ1画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ2名称</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 title_area store_detail_title_2">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ2役職</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 job_area store_job_title_2">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ2説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_2"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ2画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ3名称</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 title_area store_detail_title_3">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ3役職</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 job_area store_job_title_3">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ3説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_3"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ3画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ4名称</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 title_area store_detail_title_4">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ4役職</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 job_area store_job_title_4">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ4説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_4"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ4画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ5名称</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 title_area store_detail_title_5">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ5役職</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 job_area store_job_title_5">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ5説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_5"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ5画像</div>
									<div class="storeEditForm">
							...
							<div class="storeEditItem">
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ6名称</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 title_area store_detail_title_6">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ6役職</div>
									<div class="storeEditForm">
										<input type="text" name="" class="formTxt1 job_area store_job_title_6">
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ6説明文</div>
									<div class="storeEditForm">
										<textarea name="" rows="5" cols="" class="formTxt1 comment_area store_detail_comment_6"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">スタッフ6画像</div>
									<div class="storeEditForm">
...
<input type="hidden" id="img_path1" value="store_detail_img/chef_staff/">
<input type="hidden" id="img_path2" value="store_detail_img/chef_staff/">
<input type="hidden" id="img_path3" value="store_detail_img/chef_staff/">
<input type="hidden" id="img_path4" value="store_detail_img/chef_staff/">
<input type="hidden" id="img_path5" value="store_detail_img/chef_staff/">
<input type="hidden" id="img_path6" value="store_detail_img/chef_staff/">
