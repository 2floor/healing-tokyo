...
$option = $front_disp->get_blling_date($_SESSION['jis']['login_member']['store_basic_id']);
?>
<!DOCTYPE html>
<html lang="ja">
<head>
				...
				<?php require_once "./member_top.php"?>
					<section class="mB50">
						<div class="prts__contents_19">
							<h3 class="titleUnderline">Healing Tokyoからのお知らせ</h3>
...
<!-- 								<a href="#"><span class="btnBase btnBg1 btnW1 btnM1"><span class="btnLh2">口コミ回答</span></span></a> -->
					...
					<section class="mB50">
						<div class="prts__contents_19">
							...
							<div class="mypageManage2">
								<?php print $plan_regist_html?>

                                <div class="mypageInfoBox" id="news_html">
                                    <a href="../manual/Company_Information_Management_Registration_Manual.pdf" target="_blank">
                                        <div class="mypageInfoRow2">
                                            <div class="mypageInfoGuild"><i class="fa fa-file-pdf-o"></i></div>
                                            <div class="mypageInfoGuildPDF">
                                                事業者様情報管理登録説明書
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="mypageInfoBox" id="news_html">
                                    <a href="../manual/Activity_registration_manual_basics.pdf" target="_blank">
                                        <div class="mypageInfoRow2">
                                            <div class="mypageInfoGuild"> <i class="fa fa-file-pdf-o"></i></div>
                                            <div class="mypageInfoGuildPDF">
                                                アクティビティ登録説明書基本編
                                ...
                                <div class="mypageInfoBox" id="news_html">
                                    <a href="../manual/Activity_registration_manual_application.pdf" target="_blank">
                                        <div class="mypageInfoRow2">
                                            <div class="mypageInfoGuild"> <i class="fa fa-file-pdf-o"></i></div>
                                            <div class="mypageInfoGuildPDF">
                                                アクティビティ登録説明書応用編
                                ...
                                <div class="mypageInfoBox" id="news_html">
                                    <a href="../manual/Block_management_manual.pdf" target="_blank">
                                        <div class="mypageInfoRow2">
                                            <div class="mypageInfoGuild"><i class="fa fa-file-pdf-o"></i></div>
                                            <div class="mypageInfoGuildPDF">
                                                ブロック管理説明書
					...
					<section class="mB50">
						<div class="prts__contents_19">
							<h3 class="titleUnderline">請求書一覧</h3>
							<form action="cr_inv.php" method="get" target="_blank">
							<select name="inv_date" style="padding: 5px 10px;margin-right: 5px;">
							<?= $option; ?>
							</select>
							<button type="submit" class="btnBase btnBg1 btnW3 btnM1">請求書</button
							</form>
						</div>
					</section>
