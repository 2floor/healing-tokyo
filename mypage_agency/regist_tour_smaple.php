				...
				<div class="container760">
					...
					<section>
						...
						<div class="storeEditBtnBox">
							...
							<a href="regist_tour.php"><span class="btnBase btnBg1 btnW1"><span class="btnLh2">ツアー情報編集</span></span></a>
						...
						<div class="storeEditIn" id="inputFormArea">
							...
							<div class="storeEditItem">
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<textarea name="d_title" id="d_title" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">説明分<br>description</div>
									<div class="storeEditForm">
										<textarea name="d_detail" id="d_detail" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<textarea name="tranvel" id="tranvel" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">YOUTUBE埋め込みタグ</div>
									<div class="storeEditForm">
										<textarea name="youtube" id="youtube" rows="5" cols="" class="formTxt1 validate convert "></textarea>
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<textarea name="schedule" id="schedule" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">集合場所<br>Meeting place</div>
									<div class="storeEditForm">
										<textarea name="meeting_place" id="meeting_place" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">その他の留意点<br>Note</div>
									<div class="storeEditForm">
										<textarea name="note" id="note" rows="5" cols="" class="formTxt1 validate required">サンプルの文言
こちらで定型文を挿入、編集可能です。</textarea>
									</div>
								</div>
								<div class="storeEditRow">
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<textarea name="inclusion" id="inclusion" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">必要な持ち物<br>What to bring </div>
									<div class="storeEditForm">
										<textarea name="what_to_bring" id="what_to_bring" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<textarea name="duration" id="duration" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
											...
											<input type="hidden" name="exception_num-1" value="1">
											 <div class="exceptionDateWrap" num="1" tour="1">
												<div class="exceptionDateArea">
													<input type="text" name="exception_date-1_1" id="exception_date-1_1" class="formTxt1 validate required tour_datepicker" placeholder="日付" value="">
													<input type="text" name="ex_max_number_of_people-1_1" id="ex_max_number_of_people-1_1" class="formTxt1 validate required " placeholder="人数" value="">
										...
										<div class="storeEditForm">
											<input type="hidden" name="exception_num-2" value="1">
											 <div class=" exceptionDateWrap" num="1" tour="2">
												<div class="exceptionDateArea">
													<input type="text" name="exception_date-2_1" id="exception_date-2_1" class="formTxt1 validate required tour_datepicker" placeholder="日付" value="">
													<input type="text" name="ex_max_number_of_people-2_1" id="ex_max_number_of_people-2_1" class="formTxt1 validate required " placeholder="人数" value="">
													<button class="exBtn add">+</button>
												</div>
											</div>
											<p class="formBoxSmall">別途受付可能人数が変更のある日程とその人数を入力してください<br>※受付不可の場合は人数に「0」を入力</p>
