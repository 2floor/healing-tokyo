 ...
 * 課金売上月
 */
$capture_month = @$_POST["captureMonth"];
 ...
 */
 ...
 //想定応答の取得
  ...
  $txn_result_code = $response_data->getVResultCode();
    ...
    * 売上日時取得
    */
    $captureDateTime = $response_data->getCaptureDatetime();
...
<div class="lhtitle">キャリア決済売上：取引結果</div>
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="rivalue"><?php echo $captureDateTime ?><br/></td>
  </tr>
</table>
