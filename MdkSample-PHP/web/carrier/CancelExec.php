 ...
 * 課金取消月
 */
$cancel_month = @$_POST["cancelMonth"];
 ...
 */
 ...
 //想定応答の取得
   ...
   * 取消日時取得
   */
  $cancelDateTime = $response_data->getCancelDatetime();
...
<div class="lhtitle">キャリア決済取消：取引結果</div>
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="rivalue"><?php echo $cancelDateTime ?><br/></td>
  </tr>
</table>
