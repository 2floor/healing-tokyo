...
for ($i = 0 ; $i < $number_of_notify ; $i++) {
    ...
    $key = 'settleAmount' . $index;
    $value = $_POST[$key];
    $buf .=  $value ;
    $buf .= SEPARATOR;


    $key = 'settleDate' . $index;
    $value = $_POST[$key];
    $buf .=  $value ;
    $buf .= SEPARATOR;


    $key = 'settleRate' . $index;
    $value = $_POST[$key];
    $buf .=  $value ;
    $buf .= SEPARATOR;
