...
if (is_readable($config_file)) {
  ...
  $merchant_redirection_uri = $env_info["SAISON"]["merchant_redirection_uri.PC"];
  $PC_OR_SP_settlement_method = $env_info["SAISON"]["PC_OR_SP_settlement_method"];
}
...
$request_data->setMerchantRedirectionUri($merchant_redirection_uri);
...
// 失敗
  $processName     = htmlspecialchars("与信");
