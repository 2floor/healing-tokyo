...
// -------------------------------------------------------------------------
// 会員入会処理の実行および結果画面のサンプル
// -------------------------------------------------------------------------

 define('MDK_DIR', '../tgMdk/');
 define('INPUT_PAGE', 'AccountEntry.php');
 ...
 define('NORMAL_PAGE_TITLE', 'VeriTrans 4G - 会員入会処理サンプル画面');
 ...
 if (empty($account_id)){
     ...
     exit;
 } else if (empty($entry_kbn)) {
     $warning =  "<font color='#ff0000'><b>必須項目：入会処理区分 が指定されていません</b></font>";
     include_once(INPUT_PAGE);
     exit;
 }
...
<font size="2">
本画面はVeriTrans4G 会員入会処理のサンプル画面です。<br/>
お客様ECサイトのVeriTrans4Gとを連動させるための参考、例としてご利用ください。<br/>
</font>
</div>

<div class="lhtitle">会員入会処理実行結果</div>
