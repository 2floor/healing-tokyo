...
// -------------------------------------------------------------------------
// カード情報取得処理の実行およびカード決済-3D認証有り(PayNowIDカード情報利用)サンプル画面
// -------------------------------------------------------------------------
define('MDK_DIR', '../tgMdk/');
define('INPUT_PAGE', 'MpiAuthorize.php');
 ...
 * 決済種別
 */
$payment_mode = htmlspecialchars(@$_POST["paymentMode"]);
...
//想定応答の取得
    ...
    if (PAY_NOW_ID_SUCCESS_CODE === $pay_now_id_status) {
        ...
        // 失敗
        include_once 'MpiAuthorizeExec.php';
        exit;
    }
}
?>
...
<form name="FORM_MPI" method="post" action="MpiAuthorizeExec.php">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="thl" colspan="2">決済方法入力</td>
        </tr>
        <tr>
...
?>
       ...
       <tr>
           <td colspan="2"><input type="submit" value="実行">&nbsp;&nbsp;<span style="font-size: small; color:red;">※２回以上クリックしないでください。</span></td>
       </tr>
       ...
       <input type="hidden" name="paymentMode" value="<?php echo $payment_mode ?>">
