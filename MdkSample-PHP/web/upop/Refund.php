...
<title>VeriTrans 4G - UPOP返金サンプル画面</title>
...
<body>
    ...
    <div class="system-message">
        <font size="2"> 本画面はVeriTrans4G UPOP決済の返金取引サンプル画面です。<br />
    ...
    <table>
        ...
        <tr>
            <td>
                <div class="lhtitle">UPOP決済：返金請求</div>
            </td>
    ...
    <form name="FORM_UPOP" method="post" action="RefundExec.php">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2"><input type="submit" value="返金請求"></td>
            </tr>
        </table>
    </form>
