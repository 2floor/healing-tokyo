 ...
 */
 ...
 //想定応答の取得
   ...
   * 残高取得
   */
  $txn_balance = $response_data->getBalance();
  /**
   * 利用ポイント取得
   */
  $txn_use_point = $response_data->getUsePoint();
  /**
   * エラーメッセージ取得
   */
  $txn_give_point = $response_data->getGivePoint();
  /**
   * 結果コード取得
   */
   ...
   * 取消日時取得
   */
  $cancel_datetime = $response_data->getCancelDatetime();
...
<font size="2">
本画面はVeriTrans4G リクルートかんたん支払いの取消取引サンプル画面です。<br/>
お客様ECサイトのショッピングカートとVeriTrans4Gとを連動させるための参考、例としてご利用ください。<br/>
</font>
</div>
<div class="lhtitle">リクルートかんたん支払い取消：取引結果</div>
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="rivalue"><?php echo $txn_balance ?><br/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="rititle">取消日時</td>
    <td class="rivalue"><?php echo $cancel_datetime ?><br/></td>
  </tr>
</table>
