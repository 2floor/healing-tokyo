...
if (is_readable($config_file)) {
  ...
  $merchant_redirection_url = $env_info["ORICOSC"]["merchant_redirection_url.MB"];
}
...
$item_name1 = mb_convert_encoding($item_name1, "UTF-8", "Shift_JIS");
/** 数量１ */
...
$item_name2 = mb_convert_encoding($item_name2, "UTF-8", "Shift_JIS");
/** 数量２ */
...
$item_name3 = mb_convert_encoding($item_name3, "UTF-8", "Shift_JIS");
/** 数量３ */
...
$item_name4 = mb_convert_encoding($item_name4, "UTF-8", "Shift_JIS");
/** 数量４ */
...
$item_name5 = mb_convert_encoding($item_name5, "UTF-8", "Shift_JIS");
/** 数量５ */
...
// 成功
  $entry_form = mb_convert_encoding($response_data->getResResponseContents(), "SJIS", "UTF-8");
  echo $entry_form;
  exit();
}
$processName     = htmlspecialchars(mb_convert_encoding("画面表示", "SJIS", "UTF-8"), ENT_COMPAT | 'ENT_HTML401', "Shift_JIS");
