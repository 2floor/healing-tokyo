...
<div class="lhtitle">銀行振込決済：入金取消請求</div>

<form name="FORM_VIRTUALACC" method="post" action="DepositReverseExec.php" accept-charset="UTF-8">
...
<tr>
  <td class="ititle">入金ID</td>
  <td class="ivalue"><input type="text" maxlength="4" size="5" name="depositId" value="<?php echo htmlspecialchars(@$_POST["depositId"]) ?><?php echo htmlspecialchars(@$_GET["price"]) ?>"></td>
</tr>
...
<tr>
  <td colspan="2"><input type="submit" value="入金取消">&nbsp;&nbsp;<font size="2" color="red">※２回以上クリックしないでください。</font></td>
</tr>
</table>
</form>
