...
<title>VeriTrans 4G - 銀行振込消込請求サンプル画面</title>
...
<font size="2">
本画面はVeriTrans4G 銀行振込決済の消込取引サンプル画面です。<br/>
...
<div class="lhtitle">銀行振込決済：消込請求</div>

<form name="FORM_VIRTUALACC" method="post" action="ReconcileExec.php" accept-charset="UTF-8">
...
<tr>
  <td colspan="2"><input type="submit" value="消込">&nbsp;&nbsp;<font size="2" color="red">※２回以上クリックしないでください。</font></td>
</tr>
</table>
</form>
