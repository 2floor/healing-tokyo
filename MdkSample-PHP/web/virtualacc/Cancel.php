...
<title>VeriTrans 4G - 銀行振込決済取消サンプル画面</title>
...
<font size="2">
本画面はVeriTrans4G 銀行振込決済の取消取引サンプル画面です。<br/>
...
<div class="lhtitle">銀行振込決済：取消請求</div>

<form name="FORM_VIRTUALACC" method="post" action="CancelExec.php" accept-charset="UTF-8">
