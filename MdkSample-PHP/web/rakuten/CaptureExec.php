 ...
 */
 ...
 //想定応答の取得
   ...
   * 売上要求日時取得
   */
  $capture_req_datetime = $response_data->getCaptureReqDatetime();
...
<font size="2">
本画面はVeriTrans4G 楽天ID決済の売上取引サンプル画面です。<br/>
お客様ECサイトのショッピングカートとVeriTrans4Gとを連動させるための参考、例としてご利用ください。<br/>
</font>
</div>
<div class="lhtitle">楽天ID決済売上：取引結果</div>
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="rititle">売上要求日時</td>
    <td class="rivalue"><?php echo $capture_req_datetime ?><br/></td>
  </tr>
</table>
