...
define('NORMAL_PAGE_TITLE', 'Refund Result (取消結果)');
...
<div class="lhtitle">MasterPass Refund Result<br/>(決済取消：取引結果)</div>
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="rititle">Cancel datetime<br/>(取消日時)</td>
