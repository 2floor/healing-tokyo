...
<title>VeriTrans 4G - PayPal決済返金サンプル画面</title>
...
<font size="2">
本画面はVeriTrans4G PayPal決済の返金取引サンプル画面です。<br/>
...
?>
<div class="lhtitle">PayPal決済：返金請求</div>
<table border="0" cellpadding="0" cellspacing="0">
<form name="FORM_PAYPAL" method="post" action="RefundExec.php">
<tr>
  <td class="ititletop">返金対象取引ID</td>
  <td class="ivaluetop"><input type="text" maxlength="100" size="30" name="orderId" value="<?php echo htmlspecialchars(@$_POST["orderId"]) ?>"></td>
</tr>
<tr>
  <td class="ititle">返金金額</td>
