...
// PayPalで与信状態の取引を基に売上を立てるアクション
define('ACTION_TYPE', 'capture');
 ...
 */
 if (empty($order_id)){
  ...
  $warning =  "<font color='#ff0000'><b>必須項目：売上金額が指定されていません</b></font>";
  include_once(INPUT_PAGE);
  exit;
 }
...
<div class="lhtitle">PayPal決済売上：取引結果</div>
