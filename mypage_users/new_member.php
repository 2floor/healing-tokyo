							...
							<div class="storeEditIn" id="inputFormArea">
								...
								<div class="storeEditRow">
                                    ...
                                    <div class="storeEditRow">
                                        ...
                                        <div class="storeEditForm required_form">
                                            <input type="text" name="last_name" id="last_name" class="formTxt1 validate required " value="<?php print $first_name?>">
                                        </div>
                                    </div>
									<div class="storeEditRow">
									...
									<div class="storeEditRow">
										...
										<div class="storeEditForm">
											<p>※8 to 20 characters mixing alphabets and numbers.</p>

											<input type="password" name="password" id="password" class="formTxt1 validate required password half_width" value="">
									...
									<div class="storeEditRow">
										...
										<div class="storeEditForm">
											<input type="password" name="password_conf" id="password_conf" class="formTxt1 validate required password_conf half_width" value="">
										</div>
									</div>
