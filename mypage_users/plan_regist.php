...
// }else{
// 	require_once $_SERVER ['DOCUMENT_ROOT'] . '/jis/logic/common/common_logic.php';
// 	require_once $_SERVER ['DOCUMENT_ROOT'] . '/jis/model/t_store_seat_model.php';
// 	$t_store_seat_model = new t_store_seat_model();
// 	$common_logic = new common_logic();

// 	$seat = $t_store_seat_model->get_store_seat_match_store_id($_SESSION['try_login_member_data']['store_basic_id']);
// 	$store_result = $common_logic->select_logic_no_param("select * from t_store_basic where store_basic_id = '".$_SESSION['try_login_member_data']['store_basic_id']."'");
// 	if(!isset($seat)){
// 		$script_html = '
// 			<script>
// 				alert("座席情報登録後にご利用になれる機能です。\r\n座席登録ページへ移動します。");
// 				location.href = "./edit_seat.php";
// 			</script>
// 			';
// 	} else if ($store_result[0]['store_top_title'] == null || $store_result[0]['store_top_title'] == '') {
// 		$script_html = '
// 			<script>
// 				alert("店舗情報を全て登録後にご利用になれる機能です。\r\n店舗TOP登録ページへ移動します。");
// 				location.href = "./edit_reason.php";
// 			</script>
// 			';
// 	} else if ($store_result[0]['store_name_kana'] == null || $store_result[0]['store_name_kana'] == '') {
// 		$script_html = '
// 			<script>
// 				alert("店舗情報を全て登録後にご利用になれる機能です。\r\n店舗基本情報の登録ページへ移動します。");
				...
				<div class="container760">
					...
					<section class="borderBox">
						<div class="storeEditIn">
							<h4 class="titleBN">プラン登録<span class="registTit1" id="conf_text">以下の項目はすべて<span class="registTit2">※必須項目</span>です。</span></h4>
							<div class="storeEditItem">
								<div class="storeEditRow">
									<div class="storeEditCate">種別</div>
									<div class="storeEditForm">
										<span class="registBoxHalf">
											<select name="day_night_flg" id="day_night_flg" class="formTxt2 validate required">
												<option value="0" selected>ランチ</option>
												<option value="1">ディナー</option>
												<option value="2">バー</option>
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<textarea name="title" id="" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">説明</div>
									<div class="storeEditForm">
										<textarea name="detail" id="" rows="5" cols="" class="formTxt1 validate required"></textarea>
									</div>
								</div>
								<div class="storeEditRow">
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<span class="registBox33">
											<input type="text" name="charge" id="charge" class="formTxt2 validate required number"><span class="registItem">円</span>
										</span><span class="registBox33">※税・サービス税込</span>
									</div>
								</div>
								<div class="storeEditRow">
									<div class="storeEditCate">プラン時間帯</div>
									<div class="storeEditForm">
										<span class="formRBox"><input type="radio" class="" name="noon_night_flg" value="0" checked>昼</span>
										<span class="formRBox"><input type="radio" class="" name="noon_night_flg" value="1">夜</span>
									</div>
								</div>
								...
								<div class="storeEditRow">
									...
									<div class="storeEditForm">
										<input type="text" name="available_num" id="available_num" class="formTxt1 validate required number">
									</div>
								</div>
								<div class="storeEditRow">
...
<input type="hidden" id="edit_flg" value="0">
