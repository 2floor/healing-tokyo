							...
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<select class="form-control"  name="dear_id" id="dear_id">
												</select>
											</div>
										</div>
									</div>
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate required" name="category" id="category" value="">
											</div>
										</div>
									</div>
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate required" name="category_eng" id="category_eng" value="">
											</div>
										</div>
									</div>
