							...
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate required" name="ad" id="ad" value="">
											</div>
										</div>
									</div>
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate required" name="ad_eng" id="ad_eng" value="">
											</div>
										</div>
									</div>
...
<script src="../assets/admin/js/ad.js"></script>
...
<input type="hidden" id="ct_url" value="../controller/admin/ad_ct.php">
...
<!--  //ファイル即時アップロード用CT -->
<input type="hidden" id="img_path1" value="ad/">
...
<!-- 1ページに表示する件数 -->
<input type="hidden" id="page_disp_cnt" value="9999999999">
