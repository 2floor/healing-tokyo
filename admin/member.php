							...
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									<div class="formRow">
										<div class="formItem">
                                            名前
                                            <span class="label01 require_text">名前</span>
										</div>
										<div class="formTxt">
											<div class="formIn50">
                                    ...
                                    <div class="formRow">
                                        <div class="formItem">
                                            名字
                                            <span class="label01 require_text">名字</span>
                                        </div>
                                        <div class="formTxt">
                                            <div class="formIn50">
                                                <input type="text" class="form-control validate required" name="last_name" id="name" value="">
                                            </div>
                                        </div>
                                    </div>
									<div class="formRow">
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
                                                <input name="tel" type="text" id="phone" class="formTxt1 validate required" value="" placeholder=""/>
