			...
			<div class="container1080 cf">
				...
				<div class="container760">
					<section class="mB50">
						...
						※ Healing Tokyo uses JavaScript. Please set JavaScript to "Enable".
					...
					<section class="mB50">
						...
						<div class="enviTxt">
							Healing Tokyo has introduced SSL (Secure Socket Layer), so you can securely exchange important data such as personal information and credit card information.
						</div>
