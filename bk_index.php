	...
	<div class="container headerAreaWrap">
		<div class="headerLogoArea">
			<a href="<?php print $path?>" class="headerLogoAreaLink">
				<h1><img class="scShow" src="img/logo_pn.png" alt="Healing Tokyo"><img class="scHide" src="img/logo_wh.png" alt="Healing Tokyo"></h1>
			</a>
		</div>
			...
			<div class="headerMenuTop">
				<div class="headerMenuTopWrap">
					<div class="headerMenuTopBox">
						<a href="advertise_eg.php" class="headerMenuTopLink">For beginner</a>
					</div>
					<div class="headerMenuTopBox">
						<a href="advertise_eg.php#FAQ" class="headerMenuTopLink">Help</a>
					</div>
					<div class="headerMenuTopBox">
						<a href="contact.php?area=true" class="headerMenuTopLink">Contact</a>
					</div>
					<div class="headerMenuTopBox">
						<a href="contact.php?area=true" class="headerMenuTopLink">Contact</a>
					</div>
